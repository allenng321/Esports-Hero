...
namespace Game.Scripts.GameManagement
{
    public static class PlayerWinChanceCalculator
    {
        ...
        public static int CalculateWinChance(out int kills, out int deaths)
        {
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 5000)
            {
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 3000)
            {
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 1000)
            {
                chance += 17;
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 750)
            {
                chance += 15;
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 500)
            {
                chance += 10;
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 100)
            {
                chance += 5;
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 50)
            {
            ...
            else if (CurrentPlayerData.gameLeaderboardRating > 10)
            {
